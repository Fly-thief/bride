      ...
      <div>
        ...
        <van-action-sheet v-model="show" title="案例筛选">
          ...
          <div class="content1">
            ...
            <div class="flex-row">
              <button
                v-for="(item, index) of manner"
                :key="index"
                @click="screen_2($event, index)"
                class="item"
              >
                {{ item }}
              </button>
        ...
        <mt-tab-container-item :id="active">
          ...
          >
            <div class="content">
              ...
              <p>
                <span
                  >#{{ item.manner }}#{{ item.scene }}#{{ item.color }}</span
                >
  ...
  methods: {
    ...
    confirm() {
      ...
      if (this.screen.length > 0) {
        ...
        //向后台发请求,获取后台数据
        this.axios
          .get("/list/scene", { params: { alter: this.screen } })
          .then((result) => {
      ...
      if (this.screen3 != this.price[value]) {
        ...
        switch (value) {
          case 0:
            ...
            break;
          case 1:
            this.screen3 = "5000-10000";
            break;
          case 2:
            this.screen3 = "10000-20000";
            break;
          case 3:
            this.screen3 = "20000-30000";
            break;
          default:
            return;
        }
